	...
	match chosen_cutscene:
		...
		Util.CUTSCENES.AFTER_FINAL_BOSS:
			return [
				...
				"Nie żył długo.",
				2.5,
				"Ale żył tak, jakby każdy dzień od niego zależał.",
				2.5,
				"Nie był chciwy. Nie był dumy.",
				2.5,
				"Robił to z wyboru. Z potrzeby.",
				2.5,
				"Z miłości do świata, który o nim nie wiedział.",
				2.5,
				"Nigdy nie narzekał.",
				2.5,
				"Nigdy nie prosił o ulgę.",
				2.5,
				"Wiedział, co robi. I wiedział, co to znaczy.",
				2.5,
				Util.CUTSCENE_FLAGS.FADE_OUT,
				1.2,
				"Zmarł młodo, ale żyć będzie w każdej chwili, którą uratował.",
				3.0,
				"",
				1.0,
				Util.CUTSCENE_FLAGS.TO_MAIN_MENU
